...
export const mockTemples = [
  {
    ...
    deity: 'Lord Shiva',
    verified: true,
    images: ['https://images.unsplash.com/photo-1587474260584-136574528ed5?w=1200&q=80&auto=format']
  },
  {
    _id: 'mock-temple-2',
    ...
    verified: true,
    images: ['https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=1200&q=80&auto=format']
  }
];
...
export const mockCampaigns = [
  {
    ...
    status: 'active',
    featured: true,
    images: ['https://images.unsplash.com/photo-1587474260584-136574528ed5?w=1600&q=80&auto=format'],
  ...
  },
  {
    ...
    temple: {
      ...
      location: { address: 'Village Road, Rural Area', city: 'Rural District', state: 'Uttar Pradesh' },
      deity: 'Lord Rama'
    },
    creator: mockUsers[1],
    ...
    status: 'active',
    featured: true,
    images: ['https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=1600&q=80&auto=format'],
    deadline: new Date(Date.now() + 60 * 24 * 60 * 60 * 1000),
    createdAt: new Date(Date.now() - 15 * 24 * 60 * 60 * 1000),
    updates: [
      { title: 'Land Acquisition Complete', description: 'The land for the new temple has been successfully acquired. Construction will begin soon.', createdAt: new Date(Date.now() - 8 * 24 * 60 * 60 * 1000) }
    ]
  },
  {
    _id: 'mock-campaign-5',
...
export const mockApiResponses = {
  campaigns: {
    ...
    campaigns: mockCampaigns.map(campaign => ({
      ...
      temple: { name: campaign.temple.name, location: campaign.temple.location, deity: campaign.temple.deity },
      creator: { name: campaign.creator.name },
      createdAt: campaign.createdAt
    })),
    count: mockCampaigns.length
  },
  
  userStats: { success: true, totalDonated: 5000, donationCount: 4, campaignsCreated: 0 },
  ...
  userDonations: {
    ...
    donations: mockDonations.map(donation => ({
      ...
      campaign: { id: donation.campaign._id, title: donation.campaign.title, images: donation.campaign.images }
    })),
    pagination: { currentPage: 1, totalPages: 1, totalCount: mockDonations.length, hasNext: false, hasPrev: false }
  }
};
...
export const mockPaymentResponse = {
  ...
  donation: { id: 'mock-donation-' + Date.now(), amount: 1000, status: 'completed', campaignTitle: 'Mock Campaign' }
};
